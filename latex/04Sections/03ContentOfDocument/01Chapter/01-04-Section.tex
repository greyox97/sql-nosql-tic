...
Para el frontend se utilizó React por su capacidad de construir interfaces reactivas con componentes reutilizables~\parencite{banks2020learning, hoque2020fullstack}. Se integró Next.js para el renderizado híbrido y una estructura de rutas organizada, logrando una interfaz donde el usuario escribe consultas y visualiza resultados de forma inmediata~\parencite{vercel2024docs}.
