...
La iteración inicial (sprint 0) se dedicó a definir la arquitectura del sistema y validar la viabilidad técnica y funcional mediante prototipos. Los pasos detallados de configuración del entorno de desarrollo (Firebase, Next.js, dependencias de Python) se documentan en el Anexo III.
